  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hovered ? 'rgba(243,241,237,.28)' : 'rgba(243,241,237,.14)'}`,
        background: hovered ? 'rgba(243,241,237,.08)' : 'rgba(243,241,237,.04)',
    ...
    >
      ...
      <span style={{ fontSize: '19px', fontWeight: 800, letterSpacing: '-.02em', color: color.paper }}>{meta.label}</span>
      <span style={{ fontSize: '14px', lineHeight: 1.55, color: 'rgba(243,241,237,.68)' }}>{NOTES[meta.id]}</span>
      <span
        style={{
          marginTop: 'auto',
          paddingTop: '10px',
...
export default function ModesBand() {
  ...
  return (
    <section id="modes" style={{ background: color.ink, padding: 'clamp(70px,8vw,120px) 0' }}>
